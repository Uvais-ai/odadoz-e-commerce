...
(function($) {
  ...
  $("#filterButton").on("click", function () {
    // Update: Ensure values are set correctly before form submission
  ...
  //       $("#min_price").val(ui.values[0]);  // Update: Ensure values are set correctly
  //       $("#max_price").val(ui.values[1]);  // Update: Ensure values are set correctly
  //     },
  //   });
  //   $("#amount").val(
  //     "$" +
